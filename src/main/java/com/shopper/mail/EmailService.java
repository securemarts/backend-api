package com.shopper.mail;

import com.shopper.mail.zeptomail.ZeptomailClient;
...
public class EmailService {
    ...
    public void sendVerificationOtp(String to, String otp, String recipientName) {
        ...
        String subject = "Verify your email - Shopper";
        // Single-line HTML to match Zeptomail working curl payload style.
        String htmlBody = "<div><p>Hi " + escapeHtml(name) + ",</p><p>Your verification code is: <b>" + escapeHtml(otp) + "</b></p><p>This code expires in 10 minutes.</p><p>- Shopper</p></div>";
    ...
    public void sendPasswordReset(String to, String resetLink, String recipientName) {
        String name = recipientName != null && !recipientName.isBlank() ? recipientName : "there";
        String subject = "Reset your password - Shopper";
