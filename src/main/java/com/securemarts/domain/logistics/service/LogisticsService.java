...
import com.securemarts.domain.logistics.entity.*;
...
public class LogisticsService {
    ...
    @Transactional
    public DeliveryOrderResponse rescheduleDelivery(Long storeId, String deliveryOrderPublicId, com.securemarts.domain.logistics.dto.RescheduleDeliveryRequest request) {
        DeliveryOrder d = deliveryOrderRepository.findByPublicId(deliveryOrderPublicId)
                .orElseThrow(() -> new ResourceNotFoundException("DeliveryOrder", deliveryOrderPublicId));
        if (!d.getStoreId().equals(storeId)) {
            throw new ResourceNotFoundException("DeliveryOrder", deliveryOrderPublicId);
    ...
    @Transactional
    public RiderResponse updateRiderVerification(String riderPublicId, com.securemarts.domain.logistics.dto.RiderVerificationRequest request) {
