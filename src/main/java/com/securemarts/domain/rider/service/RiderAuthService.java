...
import com.securemarts.domain.auth.dto.RefreshTokenRequest;
import com.securemarts.domain.auth.dto.TokenResponse;
import com.securemarts.domain.auth.dto.VerifyEmailRequest;
import com.securemarts.domain.auth.entity.EmailVerificationOtp;
import com.securemarts.domain.auth.service.EmailVerificationService;
import com.securemarts.domain.logistics.entity.Rider;
import com.securemarts.domain.logistics.repository.RiderRepository;
import com.securemarts.domain.rider.entity.RiderRefreshToken;
import com.securemarts.domain.rider.repository.RiderRefreshTokenRepository;
...
public class RiderAuthService {
    ...
    @Transactional
    public TokenResponse register(com.securemarts.domain.rider.dto.RiderRegisterRequest request) {
        ...
        emailVerificationService.createAndSendOtp(rider.getEmail(), EmailVerificationOtp.TargetType.RIDER,
                rider.getFirstName());
        com.securemarts.domain.rider.dto.RiderLoginRequest loginReq = new com.securemarts.domain.rider.dto.RiderLoginRequest();
    ...
    @Transactional
    public TokenResponse login(com.securemarts.domain.rider.dto.RiderLoginRequest request) {
